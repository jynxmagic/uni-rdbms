...
INSERT INTO DIRECTOR(DIRECTOR)
    ...
    AND DIRECTOR2 NOT IN (SELECT DIRECTOR FROM DIRECTOR);
COMMIT;
...
INSERT INTO DIRECTOR(DIRECTOR)
    ...
    AND DIRECTOR3 NOT IN (SELECT DIRECTOR FROM DIRECTOR);
COMMIT;
...
INSERT INTO DIRECTOR(DIRECTOR)
    ...
    AND DIRECTOR4 NOT IN (SELECT DIRECTOR FROM DIRECTOR);
COMMIT;
